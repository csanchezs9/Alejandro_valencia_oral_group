...
export const IPhoneMockup: React.FC<IPhoneMockupProps> = ({
  ...
  innerShadow = true,
  style, className, frameStyle, screenStyle,
  children,
}) => {
  ...
  const wallpaperStyle: CSSProperties | undefined = wallpaper
    ? { position: 'absolute', inset: 0, backgroundImage: `url(${wallpaper})`, backgroundSize: wallpaperFit, backgroundPosition: wallpaperPosition, backgroundRepeat: 'no-repeat', zIndex: 0 }
    : undefined;
